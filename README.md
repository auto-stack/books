...
|---|------|-----------|--------|----------|------------|-------|
| 1 | [Auto vs The Rust Programming Language](#auto-vs-the-rust-programming-language) | [`rust/`](rust/) | [*The Rust Programming Language*](https://doc.rust-lang.org/book/) | 22 (ch00-21 + appendix) | `a2r` → Rust | Systems programming, ownership, actors, async |
| 2 | [Auto vs TypeScript Handbook](#auto-vs-typescript-handbook) | [`typescript/`](typescript/) | [*TypeScript Handbook*](https://www.typescriptlang.org/docs/handbook/) · [GitHub](https://github.com/microsoft/TypeScript-New-Handbook) | 10 (ch00-09) | `a2ts` → TypeScript | Web development, types, classes, modules |
| 3 | [Auto vs TypeScript DeepDive](#auto-vs-typescript-deepdive) | [`typescript-deepdive/`](typescript-deepdive/) | [*TypeScript Deep Dive*](https://basarat.gitbook.io/typescript/) · [GitHub](https://github.com/basarat/typescript-book) | 16 (ch00-15) | `a2ts` → TypeScript | Advanced type system, generics, pattern matching |
